      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="min-h-[44px] min-w-[44px] rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50"
          >
            {isLoading ? (
